...
{
    public class MockVocabularyService : IVocabularyService
    {
        private readonly JapaneseDbContext _context;
        public MockVocabularyService(JapaneseDbContext context) => _context = context;
        ...
        //lấy từ vựng theo id
        public async Task<VocabularyDTO> GetVocabularyByIdAsync(int vocabularyId)
        {
