...
namespace BackendAPI.Migrations
{
    ...
    [Migration("20260614051812_addfoldervocabularies")]
    partial class addfoldervocabularies
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackendAPI.Models.FolderVocabulary", b =>
                {
                    ...
                    b.Property<int?>("UserFlashcardListId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserFlashcardListId");

                    b.HasIndex("UserVocabularyId");

                    b.ToTable("FolderVocabularies");
                });
            ...
            modelBuilder.Entity("BackendAPI.Models.FolderVocabulary", b =>
                {
                    b.HasOne("BackendAPI.Models.UserFlashcardList", null)
                        .WithMany("FolderVocabularies")
                        .HasForeignKey("UserFlashcardListId");

                    b.HasOne("BackendAPI.Models.UserVocabulary", null)
                        .WithMany("FolderVocabularies")
