namespace BackendAPI.Models.Data
{
    public class DbInitializer
    {
        public static void Initialize(JapaneseDbContext context)
        {
            ...
            {
                new UserVocabulary { Kanji = "努力", Hiragana = "どりょく", Meaning = "Nỗ lực", Romaji = "doryoku", IsMastered = false, ReviewCount = 2, LastReviewed = DateTime.Now, CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now },
                new UserVocabulary { Kanji = "成功", Hiragana = "せいこう", Meaning = "Thành công", Romaji = "seikou", IsMastered = true, ReviewCount = 6, LastReviewed = DateTime.Now, CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now },
                new UserVocabulary { Kanji = "構造体", Hiragana = "こうぞうたい", Meaning = "Cấu trúc", Romaji = "kouzoutai", IsMastered = false, ReviewCount = 0, LastReviewed = DateTime.Now, CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now }
            };
