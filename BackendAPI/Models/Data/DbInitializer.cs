namespace BackendAPI.Models.Data
{
    public class DbInitializer
    {
        ...
        //    {
        //        new UserVocabulary { ListId = flashcardLists[0].Id, Kanji = "努力", Hiragana = "どりょく", Meaning = "Nỗ lực", Romaji = "doryoku", AudioUrl = "/audio/usr/doryoku.mp3", ExampleSentence = "努力は必ず報われる。 (Nỗ lực chắc chắn sẽ được đền đáp.)", IsMastered = false, ReviewCount = 2, LastReviewed = DateTime.Now, CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now },
        //        new UserVocabulary { ListId = flashcardLists[0].Id, Kanji = "成功", Hiragana = "せいこう", Meaning = "Thành công", Romaji = "seikou", AudioUrl = "/audio/usr/seikou.mp3", ExampleSentence = "プロジェクトが成功した。 (Dự án đã thành công.)", IsMastered = true, ReviewCount = 6, LastReviewed = DateTime.Now, CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now },
        //        new UserVocabulary { ListId = flashcardLists[1].Id, Kanji = "構造体", Hiragana = "こうぞうたい", Meaning = "Cấu trúc", Romaji = "kouzoutai", AudioUrl = "/audio/usr/kouzou.mp3", ExampleSentence = "構造体を破壊する。 (Phá hủy cấu trúc.)", IsMastered = false, ReviewCount = 0, LastReviewed = DateTime.Now, CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now }
        //    };
